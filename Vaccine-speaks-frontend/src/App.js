...
import sentData from "./data/user.json"; // Default import
...
function App() {
  ...
  return (
    <div>
      <ReactMapGL
        {...viewport}
        mapboxApiAccessToken="pk.eyJ1Ijoic2lkZGhhcnRoMDciLCJhIjoiY2tsb3E4cTZ2MGRzbTJ2cGhkd2Q3MHI5MSJ9.O5f7ajIyhJokof7n9yuHUA"
